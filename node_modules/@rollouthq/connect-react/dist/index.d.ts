...
import { EndUser, Credential, Customer as Customer$1 } from '@rollouthq/prisma';
...
declare type Automation$2 = InferMutationOutput<"automations.create">;
...
declare type Automation$1 = NonNullable<InferQueryOutput<"automations.get">>;
declare type AutomationEditorProps = {
    automationId: string;
    onAutomationDeleted?: () => void;
    onAutomationUpdated?: (automation: Automation$1) => void;
    onCancel?: () => void;
    renderFields?: AutomationFormProps["renderFields"];
};
...
declare const zAutomation: z.ZodObject<{
    id: z.ZodString;
    ...
    action: z.ZodUnion<[z.ZodObject<{
        ...
        appKey: "activeCampaign" | "asana" | "clickup" | "close" | "discord" | "freshsales" | "freshservice" | "gmail" | "googleCalendar" | "googleDocs" | "googleSheets" | "hubspot" | "intercom" | "jiraSoftwareCloud" | "klaviyo" | "mailchimp" | "microsoftExcel" | "monday" | "msTeams" | "outlookMail" | "pipedrive" | "quickbooksOnline" | "salesforce" | "shopify" | "slack" | "trello" | "twilio" | "xero" | "zendesk" | "zoom";
        credentialId: string;
        inputParams: Record<string, any>;
        actionKey: string;
    }, {
    ...
    customData: z.ZodNullable<z.ZodRecord<z.ZodString, z.ZodAny>>;
    subscribeData: z.ZodNullable<z.ZodRecord<z.ZodString, z.ZodAny>>;
}, "strip", z.ZodTypeAny, {
    id: string;
    deleted: boolean;
    active: boolean;
...
declare type Automation = z.infer<typeof zAutomation>;
...
declare const actions$t_createAccount: typeof createAccount;
declare namespace actions$t {
  export {
    actions$t_createAccount as createAccount,
...
declare const actions$s_deleteTask: typeof deleteTask;
declare namespace actions$s {
  export {
    createTask$1 as createTask,
    actions$s_deleteTask as deleteTask,
...
declare const actions$r_createTask: typeof createTask;
declare namespace actions$r {
  export {
    actions$r_createTask as createTask,
  };
}
